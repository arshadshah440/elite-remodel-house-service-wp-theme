 ...
 * text - sits directly under the header. Uses the shared .erh-page-banner
 * styles (assets/css/pages.css) also used by the Contact page.
 *
...
$erh_text = erh_field( 'about_banner_text' );
?>
<section class="erh-page-banner">
	<div class="erh-container">
		...
		<?php
		erh_split_heading(
			erh_field( 'about_banner_title' ),
			(int) erh_field( 'about_banner_title_highlight' ),
			'h1'
		);
		?>
