<?php
/**
 * Service Listing page section: Banner.
 *
 ...
 * as the About, Contact, FAQ and Privacy Policy pages.
 *
...
$erh_text = erh_field( 'service_listing_banner_text' );
?>
<section class="erh-page-banner">
	<div class="erh-container">
		...
		<?php erh_eyebrow( erh_field( 'service_listing_banner_eyebrow' ) ); ?>

		<?php
		erh_split_heading(
			erh_field( 'service_listing_banner_title' ),
			(int) erh_field( 'service_listing_banner_title_highlight' ),
			'h1'
		);
		?>
